...
clear 
echo -e "\033[32m     ╔═══════════════════════════════════════════════════════════════╗" 
echo -e "\033[32m     ╠>    ~ TufanScript.com | SİNUSBOT / MUZİKBOT KURULUMU  ~       ║"
echo -e "\033[32m     ╠> ~ BU SCRİPT \033[NihatTufan\033[32m TARAFINDAN KODLANMIŞTIR ~║" 
echo -e "\033[32m     ╚═══════════════════════════════════════════════════════════════╝" 
